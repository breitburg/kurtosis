...
const SORT_LABELS = {
  [SortOption.SEAT_NUMBER]: 'Seat number',
  [SortOption.TOTAL_AVAILABLE]: 'Total available hours',
  [SortOption.MAX_CONSECUTIVE]: 'Max consecutive hours',
  [SortOption.AVAILABLE_NOW]: 'Available right now'
};
...
const MainPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <header className="flex items-start gap-8 p-8">
        {/* Left: Library Name */}
        <div className="w-[260px]">
          <select 
            className="library-select text-xl leading-tight font-medium text-black bg-white border-none outline-none cursor-pointer"
        ...
        <div className="flex-1 flex">
          <select 
            className="text-base text-black bg-white border-none outline-none cursor-pointer"
            value={selectedDate || ''}
